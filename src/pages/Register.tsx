          ...
          <div className="relative z-10">
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="flex items-start gap-3 py-2">
                <input type="checkbox" className="mt-1 accent-obsidian" id="terms" />
              ...
              <button className="w-full btn-volt py-4 text-base tracking-widest flex items-center justify-center gap-2 group mt-4">
